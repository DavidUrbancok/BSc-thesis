...
namespace CMS.Tests
{
    ...
    /// </summary>
    internal class InfoProviderFake<TInfo, TProvider> : IFake, IInfoProviderFake<TInfo, TProvider> 
        where TInfo : AbstractInfoBase<TInfo>, IInfo, new()
        where TProvider : AbstractInfoProvider<TProvider>, new()
    {
        #region "Variables"
        ...
        /// Faked provider
        /// </summary>
        private readonly List<BaseAbstractInfoProvider> mProviders = new List<BaseAbstractInfoProvider>();
        ...
        private BaseAbstractInfoProvider mProviderObject;
        private BaseAbstractInfoProvider mOriginalProviderObject;
        ...
        /// Provider object
        /// </summary>
        public BaseAbstractInfoProvider ProviderObject
        {
            get
            {
        ...
        /// </summary>
        private BaseAbstractInfoProvider EnsureDefaultProvider()
        {
        ...
        /// </summary>
        private BaseAbstractInfoProvider OriginalProviderObject
        {
            get
            {
                return mOriginalProviderObject ?? (mOriginalProviderObject = (BaseAbstractInfoProvider)ProviderObject.GetCurrentProvider());
            }
            set
            {
        ...
        public void IncludeData(params TInfo[] items)
        {
            ...
            // Fake provider
            var typeInfo = ProviderObject.TypeInfo;
        ...
        {
            var query = OriginalProviderObject.GetGeneralObjectQuery();
        ...
        {
            var typeInfoEvents = ProviderObject.TypeInfo.Events;
        ...
        private void FakeProviderSource()
        {
            if (!mDataFaked)
            {
                ...
                var typeInfo = provider.TypeInfo;
                ...
                if (typeInfo.NestedInfoTypes != null)
                {
                    foreach (var nested in typeInfo.NestedInfoTypes)
                    {
                        ...
                        provider = nestedTypeInfo.ProviderObject;
        ...
        /// </summary>
        private void FakeProvider(BaseAbstractInfoProvider provider)
        {
            OriginalProviderObject = (BaseAbstractInfoProvider)provider.GetCurrentProvider();
