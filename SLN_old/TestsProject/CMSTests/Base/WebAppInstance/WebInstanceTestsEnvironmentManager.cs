...
namespace CMS.Tests
{
    ...
    public class WebInstanceTestsEnvironmentManager : IWebInstanceTestsEnvironmentManager
    {
        ...
        public string WebAppInstancePath
        {
            get
            {
                return mWebAppInstancePath ?? (mWebAppInstancePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "WebAppInstances", WebAppInstanceName));
            }
        }
        ...
        public WebInstanceTestsEnvironmentManager(string instanceName)
        {
        ...
        private void CopyFolderToWebAppInstance(string folderName)
        {
            ...
            foreach (var sourceSubFolder in Directory.GetDirectories(sourceFolder, "*", SearchOption.AllDirectories))
            {
        ...
        private void DeleteExcludedFiles()
        {
            var filePath = Path.Combine(WebAppInstancePath, @"App_Data\CMSModules\ImportExport\dev_mode");
